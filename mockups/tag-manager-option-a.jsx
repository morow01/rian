...
export default function TagManagerOptionA() {
  return (
    <div
      style={{
        minHeight: "100vh",
    ...
    >
      ...
      {/* Option A: Polished centered card */}
      <div style={{ maxWidth: 640, margin: "24px auto", padding: "0 24px" }}>
          ...
          {BUILT_IN.map((tag, i) => (
            <div
              ...
              style={{
                ...
                padding: "12px 24px",
                borderBottom:
                  i < BUILT_IN.length - 1 ? "1px solid #f0f2f5" : "none",
              }}
            >
              ...
              >
                {tag.enabled ? "Visible in filter" : "Hidden"}
              </span>
            </div>
          ))}

          {/* Divider */}
          <div style={{ height: 1, background: "#e2e6ed", margin: "0 24px" }} />
          ...
          {CUSTOM.map((tag, i) => (
            <div
              ...
              style={{
                ...
                padding: "12px 24px",
                borderBottom:
                  i < CUSTOM.length - 1 ? "1px solid #f0f2f5" : "none",
              }}
            >
              <Toggle on={tag.enabled} />
              <TagBadge name={tag.name} color={tag.color} />
        ...
        >
          Option A — Polished centered card (max-width 640px). Clean settings-page feel.
        </div>
      </div>
    </div>
  );

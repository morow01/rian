...
- Direct Row Pinning in ☰ menu: Each navigation item row has a dedicated "Pin" / "Pinned" button. Tapping it pins/unpins the item directly to/from the top header bar.
...
### Week History Redesign + Search (v6.0.26-v6.1.19)
